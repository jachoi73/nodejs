...
module.exports = {
    ...
    filtrarYOrdenarFunkos: (funkos, minPrice, maxPrice, ordenarPor, licence, category, buscar) => {
        ...
        if(buscar != ''){
            funkosFiltrados = funkosFiltrados.filter (funko => funko.product_name.toLowerCase().includes(buscar.toLowerCase()));
        }
